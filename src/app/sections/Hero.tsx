...
const Hero = () => {
  return (
    <section className="max-w-screen-2xl mx-auto text-center lg:text-start text-twc-gray mt-16 lg:mt-0 space-y-28 lg:flex justify-between items-center">
      <div className="animate-fade-up px-7 lg:pl-[13rem] max-w-lg lg:max-w-3xl mx-auto lg:mx-0">
        <div>
        ...
        <p className="text-twc-md lg:text-sm font-medium tracking-twc-tight leading-5 lg:leading-6 py-[2.19rem] lg:py-0">
        ...
        <div className="space-x-4 lg:pt-[3.44rem] flex flex-row shrink justify-center lg:justify-start">
          ...
          <button className="  text-white bg-blue-500
           hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">

              Report Lost/Found Item &gt;
              </button>
          </Link>
          <button onClick={handleOpenInNewTab} className="border border-blue-500 text-blue-500  hover:bg-blue-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            Read the Paper &gt;
          </button>
        </div>
      </div>
      ...
      <div className="animate-fade-up hidden lg:flex gradient-bg flex-shrink-0 rounded-tl-[18.75rem] justify-end">
        <Image
          src="/bag.png"
          alt="nafeel-prtrait"
          width={551}
